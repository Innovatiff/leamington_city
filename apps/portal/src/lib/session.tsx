/**
 * Session state: who is signed in, which business they manage, and which
 * language the UI is in.
 *
 * `businessId` comes from the custom claim, not from a Firestore document —
 * the claim is what security rules check, so reading anything else here would
 * let the UI and the rules disagree.
 */
...
const LOCALE_KEY = 'lc.portal.locale';
